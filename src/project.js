...
import driveclub from "./img/Driveclub.jpeg";
import todoList from "./img/ToDoList.jpeg";
import newsLetter from "./img/Newsletter.jpeg";

const project = [
  {
    name: "DriveClub Website",
    link: "https://jacquestill-driveclub.netlify.app",
    imgUrl: driveclub,
    content: "A car website created using VueJs and Sass",
    code: "https://github.com/Jacquestill/Driveclub",
  },
  {
    name: "Note Keeper",
    link: "",
    imgUrl: note,
    content:
      "A note keeping application, similar to google notes. Build using ReactJS",
    code: "https://github.com/Jacquestill/Note-Keeper",
  },
  {
    name: "To Do List Website",
    link: "https://vast-shelf-55712.herokuapp.com/",
    imgUrl: todoList,
    content:
      "This is a ToDo List Website. Build using ExpressJS and saving data on MongoDB",
    code: "https://github.com/Jacquestill/ToDoList---V2",
  },
  {
  ...
  },
  {
    ...
    link: "https://jacquestill-newssignup.herokuapp.com/",
    imgUrl: newsLetter,
    content:
      "This is a newsletter sign up website. Using Mailchimp you can send to you userbase emails.",
    code: "https://github.com/Jacquestill/Newsletter-Signup",
  },
  {
    name: "Mapty Website",
  ...
  //   link: "https://jacquestill-bankistwebsite.netlify.app/",
  //   imgUrl: bankist,
  //   content: "Optimized banking website using JavaScript",
